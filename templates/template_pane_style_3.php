...
<div id="ajaxpostloadmore" style="width:<?php echo $this->_config["tp_widget_width"]; ?>"  class="<?php echo ((trim($_is_rtl_enable)=="yes")?"apcp-rtl-enabled":""); ?> pane_style_3 <?php echo ( ( trim( $this->_config["display_title_over_image"] ) == "yes" ) ? "disp_title_over_img" : "" ); ?>">
