...
<table class="ajaxpostloadmore-admin ajaxpostloadmore-admin-widget" cellspacing="0" cellpadding="0">
	<tr> <td class="tp-label">
			<p><label for="<?php echo $this->get_field_id( 'widget_title' ); ?>"><?php echo __( 'Widget title', 'ajaxpostloadmore' ); ?>:</label></p>
	 	</td> 
		<td>
			<p>
	...
	<tr>
		<td class="tp-label">
			<p> <label for="<?php echo $this->get_field_id( 'number_of_post_display' ); ?>"><?php echo __( 'Number of post display', 'ajaxpostloadmore' ); ?>:</label> </p> 
		</td>  
		<td>
			<p> 
	...
	<tr>
		<td class="tp-label">
			<p> <label for="<?php echo $this->get_field_id( 'title_text_color' ); ?>"><?php echo __( 'Post title text color', 'ajaxpostloadmore' ); ?>:</label> </p> 
		</td>  
		<td>  
			<p> 
	...
	<tr>
		<td class="tp-label">
			<p> <label for="<?php echo $this->get_field_id( 'header_text_color' ); ?>"><?php echo __( 'Widget title text color', 'ajaxpostloadmore' ); ?>:</label> </p>
		</td> 
		<td> 
			<p> 
	...
	<tr>
		<td class="tp-label">
			<p> <label for="<?php echo $this->get_field_id( 'header_background_color' ); ?>"><?php echo __( 'Widget title background color', 'ajaxpostloadmore' ); ?>:</label> </p>
		</td> 
		<td>
			<p> 
	...
	<tr>
		<td class="tp-label">
			<p> <label for="<?php echo $this->get_field_id( 'tp_widget_width' ); ?>"><?php echo __( 'Widget Width', 'ajaxpostloadmore' ); ?>:</label> </p>
		</td> 
		<td>   
			<p> 
	...
	<tr>
		<td class="tp-label">
			<p> <label for="<?php echo $this->get_field_id( 'display_title_over_image' ); ?>"><?php echo __( 'Display title over image?', 'ajaxpostloadmore' ); ?></label> </p>
		</td> 
		<td>    
			<p> 
				...
				<label for="<?php echo $this->get_field_id( 'display_title_over_image' ); ?>_1"><?php echo __( 'Yes', 'ajaxpostloadmore' ); ?></label>
				...
				<label for="<?php echo $this->get_field_id( 'display_title_over_image' ); ?>_2"><?php echo __( 'No', 'ajaxpostloadmore' ); ?></label>
			</p>
		</td>
	</tr>
	...
	<tr>
		<td class="tp-label">
			<p> <label for="<?php echo $this->get_field_id( 'hide_widget_title' ); ?>"><?php echo __( 'Hide widget title?', 'ajaxpostloadmore' ); ?></label> </p>
		</td> 
		<td> 
			<p> 
				...
				<label for="<?php echo $this->get_field_id( 'hide_widget_title' ); ?>_1"><?php echo __( 'Yes', 'ajaxpostloadmore' ); ?></label>	
				...
				<label for="<?php echo $this->get_field_id( 'hide_widget_title' ); ?>_2"><?php echo __( 'No', 'ajaxpostloadmore' ); ?></label>
			</p>
		</td>
	</tr>
	...
	<tr>
		<td class="tp-label">
			<p> <label for="<?php echo $this->get_field_id( 'hide_post_title' ); ?>"><?php echo __( 'Hide post title?', 'ajaxpostloadmore' ); ?></label> </p>
		</td>
		<td>  
			<p> 
				...
				<label for="<?php echo $this->get_field_id( 'hide_post_title' ); ?>_1"><?php echo __( 'Yes', 'ajaxpostloadmore' ); ?></label>
				...
				<label for="<?php echo $this->get_field_id( 'hide_post_title' ); ?>_2"><?php echo __( 'No', 'ajaxpostloadmore' ); ?></label>
			</p>
		</td>
	</tr>    
	<tr>
		<td class="tp-label">
			<p> <label for="<?php echo $this->get_field_id( 'template' ); ?>"><?php echo __( 'Template', 'ajaxpostloadmore' ); ?>:</label> </p>
		</td>
		<td>
			<p> 
				<select id="<?php echo $this->get_field_id( 'template' ); ?>" name="<?php echo $this->get_field_name( 'template' ); ?>" >
					<option <?php echo ( ( $instance['template'] == 'pane_style_1' || $instance['template'] == '' ) ? "selected" : "" ); ?> value="pane_style_1"><?php echo __( 'Pane style 1', 'ajaxpostloadmore' ); ?></option>
					<option <?php echo ( ( $instance['template'] == 'pane_style_2' ) ? "selected" : "" ); ?> value="pane_style_2"><?php echo __( 'Pane style 2', 'ajaxpostloadmore' ); ?></option>
					<option <?php echo ( ( $instance['template'] == 'pane_style_3' ) ? "selected" : "" ); ?> value="pane_style_3"><?php echo __( 'Pane style 3', 'ajaxpostloadmore' ); ?></option> 
				</select>
			</p> 
		</td>
	</tr>
