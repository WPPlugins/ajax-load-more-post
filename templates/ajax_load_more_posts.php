<?php if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly    
	...
	if( ( $all_pg ) >= $cur_all_pg + 2 ) {
		?>
			<div class="clr"></div>
			<div class='ik-post-load-more' align="center" onclick='APLM_loadMorePosts( "<?php echo esc_js( $_limit_start+$_limit_end ); ?>","<?php echo esc_js( $params["vcode"] ); ?>","<?php echo esc_js( $_total ); ?>",request_obj_<?php echo esc_js( $params["vcode"] ); ?>)'>
